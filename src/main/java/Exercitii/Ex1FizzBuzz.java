package Exercitii;// 1. Given n, a natural number, implement a method that for each number from 1 to n will return:
...
public class FizzBuzz {
    ...
    public void FizzBuzz(int numberOfIterations) {
